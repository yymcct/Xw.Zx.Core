...
// 业务审批
{
  ...
  children: [
    ...
    },
    {
      ...
      component: resolve => require(['@/pages/application/approval/sysManagement/personalInformation/index'], resolve),//'@/pages/application/approval/sysManagement/personalInformation/index
      meta: {
        requireAuth: true,
      }
    },
    {
      path: '/approval/Organization', //组织机构管理
      component: resolve => require(['@/pages/application/approval/sysManagement/Organization/index'], resolve),
      meta: {
        requireAuth: false,
      }
