			...
			>
				...
				<table class="em-form-table" width="100%" align="center">
					...
					<tr>
						...
						<td class="em-person-select">
							<editor class="editor-box" @ready="editorReady" :ueditorConfig="ueditorConfig"
									:defaultMsg="NR"></editor>
						</td>
					</tr>
<!--					需求修改：将 “立即发送”和“保存到草稿箱”按钮位置调整到“写邮件”标题下面-->
	...
	export default {
		...
		data() {
			return {
				...
				ueditorConfig: {
					toolbars: [['source', 'undo', 'redo', 'link', //超链接
						'unlink', '|',//取消链接
						'forecolor', //字体颜色
						'backcolor', //背景色
						'fontfamily', //字体
