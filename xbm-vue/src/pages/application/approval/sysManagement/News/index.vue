<template>
  <div class="grid-inner-content home-laws" ref="laws-home">
    ...
    <div class="cat-left">
      ...
      <div class="laws-cat">
        <div v-if="catFromShow" class="add-cat">
          <el-input v-model="catName" placeholder="名称" class="cus-cat-input"></el-input>
          <el-button type="primary" class="cat-btn" size="mini" @click="subCatData($event)">确定</el-button>
        </div>
        <ul style="height:100%;overflow:auto;">
          ...
          >
            ...
            <div class="cat-item-right">
              <el-button type="text" style="color:red" @click="delLawsCatData($event,item.MLID)">删除</el-button>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="laws-search-form" ref="LawForm">
        ...
        >
          <el-form-item label="类型">
            <el-select v-model="formInline.mlid" placeholder="类型目录" clearable style="width:190px">
              <el-option
          ...
          <el-form-item label="标题">
            <el-input v-model="formInline.wj_name" placeholder="关键字" style="width:180px"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    >
      <add @onSubmit="onSubmit" :catList="catList" :curData="curData" v-if="dialogVisible"></add>
  ...
  methods: {
    initLayout: function() {
      ...
      this.$nextTick(() => {
        ...
        that.height =
          that.$refs["laws-home"].clientHeight - height - 100 + "px";
      });
    },
    subCatData: function(e) {
      ...
      dataService.addCat(this.catName, 1).then(res => {
        if (res.success) {
          this.getCatList();
