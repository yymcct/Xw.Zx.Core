  ...
  <div class="grid-inner-content home-laws" ref="laws-home">
    ...
    <div class="cat-box1">
      ...
      <div class="laws-search-form" ref="LawForm">
        <el-form :inline="true" :model="formInline" label-position="right" label-width="70px" class="demo-form-inline">
      ...
      >
        ...
        <el-table-column prop="WJ_NAME" show-overflow-tooltip label="标题" >
          <template slot-scope="scope">
							<span @click="handleClick(scope.row)" style="cursor:pointer" class="el-button--text">{{scope.row.WJ_NAME}}</span>
      ...
      <el-pagination
        ...
        :total="total" :page-size="formInline.pagesize"
...
export default {
  ...
  methods: {
      ...
      that.height = that.$refs['laws-home'].clientHeight - height - 130 + "px";
      });
    },
     getCatList: function() {
    ...
    handleClick: function(obj) {
      ...
      this.$router.push({ path: "/LawsDetail", query: {wiid:obj.WIID,type:obj.NAME }});
    }
  },
  components: {
