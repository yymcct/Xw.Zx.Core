  ...
  <div class="Address">
    ...
    <div class="cus-common-table" v-loading="loading">
      <el-table :data="tableData" border stripe height="100%">
        ...
        <el-table-column prop="EP_OFFICEPHONE" label="办公电话" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="EP_MOBILE1" label="手机号码" show-overflow-tooltip align="center"></el-table-column>
...
export default {
  data: function() {
    return {
      ...
      curData: null,
      type: "add",
      typep: JSON.parse(localStorage.getItem("data")).ur_ident,
      loading: false,
      title: "个人创建"
    };
  },
  ...
  methods: {
    ...
    getData: function() {
      this.loading = true;
      dataService.getAddressPersonList(this.searchForm).then(res => {
