...
{
    public class Biqilinrequest
    {
        public class RequestBase
        {
            private readonly BiqilinOption _biqilinOption;
            public RequestBase(BiqilinOption biqilinOption)
            {
                _biqilinOption = biqilinOption;
            }
            ...
            public string sign
            {
                get
                {
                    var dic = GetType()
                        .GetProperties()
                        .Where(q => q.Name != "sign" && q.Name != "_biqilinOption")
                        .OrderBy(q => q.Name)
        ...
        public class KeyDownLoad : RequestBase
        {
            public KeyDownLoad(BiqilinOption biqilinOption) : base(biqilinOption)
            {
